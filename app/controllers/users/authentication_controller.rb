  ...
  class AuthenticationController < ApiGuard::AuthenticationController
    ...
    def create
      if resource.authenticate(params[:password])
        ...
        # Next line is required for ember-simple-auth-token addon!!
        render json: {jwt: jwt_and_refresh_token(resource, resource_name)[0]}
        #render_success(data: data, message: I18n.t('api_guard.authentication.signed_in'))
      else
